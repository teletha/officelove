...
/**
 * The root event class for all native-level input events. Input events are delivered to listeners
 * as they are received by the native source. There is no method for listeners or subclasses to
 * prevent delivery of the event to the native system. There is no guarantee that the events will be
 * received by Java before they are delivered natively.
 * <p>
 *
...
public class NativeInputEvent extends EventObject {
    ...
    /**
     * Mask for undocumented behavior. More information available at:
     * <a href="https://github.com/kwhat/jnativehook/wiki/Usage#consuming-events-unsupported">wiki/
     * Usage#consuming-events-unsupported</a>
     * 
     * @since 2.0
     */
     ...
     * @param modifiers the modifier keys down during event. <code>NativeInputEvent</code> _MASK
     *            modifiers should be used as they are not compatible with the extended _DOWN_MASK
     *            or the old _MASK <code>InputEvent</code> modifiers.
     */
     ...
     * <p>
     * Event propagation support for X11 cannot be provided due to an oversight in the way that
     * XRecord currently operates. No public method will be available until a working cross-platform
    ...
    /**
     * Gets a <code>String</code> describing the modifier flags, such as "Button1", or "Ctrl+Alt".
     * These strings can be localized by changing the awt.properties file.
     *
     * @param modifiers a modifier mask describing the modifier keys and mouse buttons of an event.
    ...
    /**
     * Gets a <code>String</code> representation of this event. This method is useful for
